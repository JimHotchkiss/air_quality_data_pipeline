...
def main():
    ...
    logging.info(f"Executing CLI command with {args}")
    transform_data(args)

if __name__ == "__main__":
    main()

# CLI command - python transformation.py --database_path ../air_quality.db --query_directory ../sql/dml/presentation
# Once transformation script runs, check out in DBeaver
    # Created views appear under the presentaton folder
